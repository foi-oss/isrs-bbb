...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        for(i=0;i<24;++i){
            for(j=0;j<60;j+=30){
	       date_str = new Date(1970,1,1,i,j,0,0).strftime(time_format) 
	       quickElement("a", quickElement("li", time_list, ""), date_str, "href", "javascript:DateTimeShortcuts.handleClockQuicklink(" + num + ",'" + date_str + "');");
	    }
	}
    ...
    openClock: function(num) {
        ...
        clock_box.style.width = '150px';
        clock_box.style.height = '80px';
        clock_box.style.overflowY = 'auto';
